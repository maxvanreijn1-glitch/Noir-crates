...
export default function CollectionClient() {
  ...
  }, [sort, selectedCategories, showInStockOnly]);
    ...
    <div className={styles.page}>
      <div className="container">
        ...
        <nav className={styles.breadcrumb} aria-label="Breadcrumb">
          ...
          <span aria-current="page">Blind Boxes</span>
        </nav>

        {/* Collection header */}
        <header className={styles.collectionHeader}>
          <h1 className={styles.collectionTitle}>Blind Boxes</h1>
          <p className={styles.collectionDesc}>
            Mystery collectible figures, carefully curated. Each box holds a
            surprise — discover your next favourite character.
          </p>
        </header>
